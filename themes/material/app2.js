...
function append_files_to_list(path, files) {
  ...
  for (i in files) {
    ...
    if (item['mimeType'] == 'application/vnd.google-apps.folder') {
      ...
      html += `<li class="mdui-list-item file mdui-ripple" target="_blank"><a gd-type="${item.mimeType}" href=https://exe.io/st?api=2868c8faff0715dae89519105166e1670dc0164b&url="${p}" class="${c}">
	          <div class="mdui-col-xs-12 mdui-col-sm-7 mdui-text-truncate" title="${item.name}">
...
<div class="mdui-textfield">
	<label class="mdui-textfield-label">Link Unduh</label>
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">Link HTML</label>
